...
Hooks:PostHook(ObjectivesManager, "activate_objective", "Stopwatch_ObjectivesManager_Post_activate_objective", function(ply, id)
...
Hooks:PreHook(ObjectivesManager, "complete_objective", "Stopwatch_ObjectivesManager_Pre_complete_objective", function(ply, id)
	if Settings:get("is_active") and Network:is_server() then
        local objective = ply["_objectives"][id]
...
Hooks:PostHook(ObjectivesManager, "complete_objective", "Stopwatch_ObjectivesManager_Post_complete_objective", function(ply, id)
	if Settings:get("is_active") and Network:is_server() then
        local objective = ply["_objectives"][id]
        local objective_info = objective.stopwatch
...
Hooks:PostHook(ObjectivesManager, "remove_objective", "Stopwatch_ObjectivesManager_Post_remove_objective", function(ply, id)
	if Settings:get("is_active") and Network:is_server() then
        local objective = ply["_objectives"][id]
        local objective_info = objective.stopwatch
